...
<figure>
  <img src="{% link images/taux de reussite.png %}" alt="Carte 1" width="500">
  <figcaption>Carte 1 : Taux de réussite au brevet dans les départements des Pays de la Loire.</figcaption>
</figure>
...
![Carte 2]({% link images/repartition des collèges privés.png %})
...
![Carte 3]({% link images/nombres de candidats et taux de reussite.png %})
...
![Carte 4]({% link images/taux de reussite et collèges privés region.jpg %})
...
![Carte 5]({% link images/nombre heure absences nationale.png %})

![Carte 6]({% link images/nombre heures absences regions.png %})
...
![Carte 8]({% link images/age moyen.png %}) 
...
![Carte 9]({% link images/indice d'eloignement.jpg %})
